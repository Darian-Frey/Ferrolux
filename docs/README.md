...
>
> No open bugs and no suggested improvements. Twenty-two bugs found, twenty-one
> fixed and one won't-fix upstream. Phase 6, desktop integration, is next.
...
│   ├── platform/      # Settings, MPRIS2, media keys; CLI still to come
