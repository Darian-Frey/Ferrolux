...
- [~] Playlist and equaliser sections styled to match — the playlist is done: a well, rows in the readout face at three brightnesses rather than in three hues, the playing entry marked as well as brightened, and a selected row backlit in the dimmest amber instead of the desktop's highlight colour. The equaliser is not started
